...
linkStyle('https://play.thetrainercorner.net/style/font-awesome.css?');
linkStyle('https://play.thetrainercorner.net/style/battle.css?a7');
linkStyle('https://play.thetrainercorner.net/style/replay.css?a7');
linkStyle('https://play.thetrainercorner.net/style/utilichart.css?a7');

requireScript('https://play.thetrainercorner.net/js/lib/ps-polyfill.js');
requireScript('https://play.thetrainercorner.net/config/config.js?a7');
requireScript('https://play.thetrainercorner.net/js/lib/jquery-1.11.0.min.js');
requireScript('https://play.thetrainercorner.net/js/lib/html-sanitizer-minified.js');
requireScript('https://play.thetrainercorner.net/js/battle-sound.js');
requireScript('https://play.thetrainercorner.net/js/battledata.js?a7');
requireScript('https://play.thetrainercorner.net/data/pokedex-mini.js?a7');
requireScript('https://play.thetrainercorner.net/data/pokedex-mini-bw.js?a7');
requireScript('https://play.thetrainercorner.net/data/graphics.js?a7');
requireScript('https://play.thetrainercorner.net/data/pokedex.js?a7');
requireScript('https://play.thetrainercorner.net/data/moves.js?a7');
requireScript('https://play.thetrainercorner.net/data/abilities.js?a7');
requireScript('https://play.thetrainercorner.net/data/items.js?a7');
requireScript('https://play.thetrainercorner.net/data/teambuilder-tables.js?a7');
requireScript('https://play.thetrainercorner.net/js/battle-tooltips.js?a7');
requireScript('https://play.thetrainercorner.net/js/battle.js?a7');
