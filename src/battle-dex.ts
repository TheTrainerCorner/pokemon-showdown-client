...
const Dex = new class implements ModdedDex {
    ...
    if(this.fakemons.includes(data.spriteid)) return 'background-image:url(' + 'http://play.thetrainercorner.net/sprites/fakemons/' + data.spriteid + '.png);background-position:left;background-repeat:no-repeat';
